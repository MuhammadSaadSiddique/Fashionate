...
const config = {
  ...
  organizationName: 'thpoint0', // Usually your GitHub org/user name.
  projectName: 'climate-greentech-22-T9', // Usually your repo name.thpoint0/climate-greentech-22-T9
